    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          'bottom-0 left-0 rounded-t-xl border-t ring-1 ring-foreground/10 duration-200',
          ...
          'sm:bottom-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-w-lg sm:rounded-xl sm:border',
